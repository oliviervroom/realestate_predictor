...
st.write('''This application enables the user to identify the central point of specified locations and 
categorize addresses according to their proximity to one another. Potential use cases include determining 
a convenient meeting spotw for friends, selecting a strategic warehouse location for businesses, 
...
st.markdown("[GitHub](https://github.com/sfc38/Google-Maps-API-Streamlit-App)")
